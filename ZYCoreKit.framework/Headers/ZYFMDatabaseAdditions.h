...
/** Category of additions for `<ZYFMDatabase>` class.
...
@interface ZYFMDatabase (ZYFMDatabaseAdditions)
...
/** The schema of the database.
 ...
 @return `ZYFMResultSet` of schema; `nil` on error.

 @see [SQLite File Format](http://www.sqlite.org/fileformat.html)
 */

- (ZYFMResultSet*)getSchema;
...
- (ZYFMResultSet*)getTableSchema:(NSString*)tableName;
